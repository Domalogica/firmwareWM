...
#define WARM_SET()              HAL_GPIO_WritePin(PWR6_GPIO_Port, PWR6_Pin, GPIO_PIN_SET)
#define WARM_CLR()              HAL_GPIO_WritePin(PWR6_GPIO_Port, PWR6_Pin, GPIO_PIN_RESET)
#define COLD_SET()              HAL_GPIO_WritePin(PWR5_GPIO_Port, PWR5_Pin, GPIO_PIN_SET)
#define COLD_CLR()              HAL_GPIO_WritePin(PWR5_GPIO_Port, PWR5_Pin, GPIO_PIN_RESET)
